import profileIconImage from './profile-icon.png'; 
...
export{editTask, addTask, saveTask, renderProject, drawProjectArea, drawTask,drawProjectSidebar, drawHeader, domCreateProject}